...
ax0.plot(t_log_setpoint, sig_setpoint,
         '-', lw=0.8, alpha=0.9, color='k', dashes=[5,2],
         label='$w(t)$',
         )

ax0.plot(results01[0], results01[2],
         '-', lw=0.8, alpha=0.9, #color='k',
         label='$y(t)$ pre $\lambda$ = {:.1f}'.format(results01[-1]),
         )

ax0.plot(results02[0], results02[2],
         '-', lw=0.8, alpha=0.9, #color='k',
         label='$y(t)$ pre $\lambda$ = {:.1f}'.format(results02[-1]),
         )    

ax0.plot(results03[0], results03[2],
         '-', lw=0.8, alpha=0.9, #color='k',
         label='$y(t)$ pre $\lambda$ = {:.1f}'.format(results03[-1]),
         )                
...
ax0.plot(results01[0], results01[3],
         '-', lw=0.8, alpha=0.9, #color='k',
         label='$u(t)$ pre $\lambda$ = {:.1f}'.format(results01[-1]),
         )   

ax0.plot(results02[0], results02[3],
         '-', lw=0.8, alpha=0.9, #color='k',
         label='$u(t)$ pre $\lambda$ = {:.1f}'.format(results02[-1]),
         )      

ax0.plot(results03[0], results03[3],
         '-', lw=0.8, alpha=0.9, #color='k',
         label='$u(t)$ pre $\lambda$ = {:.1f}'.format(results03[-1]),
         )                    
