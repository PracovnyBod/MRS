...
\def\oznacenieCasti{MRS11 - ZS2024}
...
\begin{center}
    ...
    \vbox{%
    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_01a_panel_wy.pdf}
    }

    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_01a_panel_u.pdf}
    }
...
\begin{center}
    ...
    \vbox{%
    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_01a_panel_e_log.pdf}
    }
...
\begin{center}
    ...
    \vbox{%
    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_02a_panel_wy.pdf}
    }

    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_02a_panel_u.pdf}
    }
...
\begin{center}
    ...
    \vbox{%
    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_02a_panel_e_log.pdf}
    }

    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_02a_panel_int_e_log.pdf}
    }
    %
    % \makebox[\textwidth][c]{%
    % \includegraphics{MRS11_prikl_01a_panel_der_e_log.pdf}
...
\begin{center}
    ...
    \vbox{%
    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_02b_panel_wy.pdf}
    }

    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_02b_panel_u.pdf}
    }
...
\begin{center}
    ...
    \vbox{%
    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_02b_panel_e_log.pdf}
    }

    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_02b_panel_int_e_log.pdf}
    }
    %
    % \makebox[\textwidth][c]{%
    % \includegraphics{MRS11_prikl_01a_panel_der_e_log.pdf}
...
\begin{center}
    ...
    \vbox{%
    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_03a_panel_wy.pdf}
    }

    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_03a_panel_u.pdf}
    }
...
\begin{center}
    ...
    \vbox{%
    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_03b_panel_wy.pdf}
    }

    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_03b_panel_u.pdf}
    }
...
\begin{center}
    ...
    \vbox{%
    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_03c_panel_wy.pdf}
    }

    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_03c_panel_u.pdf}
    }
...
\begin{center}
    ...
    \vbox{%
    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_04_panel_wy.pdf}
    }

    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_04_panel_u.pdf}
    }
...
\begin{center}
    ...
    \vbox{%
    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_05_panel_wy.pdf}
    }

    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_05_panel_u.pdf}
    }
...
\begin{center}
    ...
    \vbox{%
    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_06_panel_wy.pdf}
    }

    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_06_panel_u.pdf}
    }
...
\begin{center}
    ...
    \vbox{%
    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_07_panel_wy.pdf}
    }

    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_prikl_07_panel_u.pdf}
    }
...
Prechodová charakteristika URO v mnohých prípadoch vykazuje tlmené oscilácie pred dosiahnutím ustáleného stavu. Príkladom nech je obr.~\ref{MRS11_kvalitaPCHURO_panel_wy}.

\begin{center}

    \vbox{%
    \makebox[\textwidth][c]{%
    \includegraphics{MRS11_kvalitaPCHURO_panel_wy.pdf}
    }


    \figcaption{}
    \label{MRS11_kvalitaPCHURO_panel_wy}
    }
